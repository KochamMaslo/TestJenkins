...
using Intergraph.WebSolutions.Core.SDIPortal.Apollo;
...
{
    public partial class Apollo : MapPageBase, IConfigurableForm
    {
        ...
        protected override void OnPreInit(EventArgs e)
        {
            ...
            if (LicenseManager.IsLicensingEnabled() && LicenseManager.IsLicenseValid(LicenseLevels.AP_PRO)){
                var defaultDocument = "ApolloPro.aspx";
        ...
        private void SetUpMapToolbar()
        {
            ...
            t.AddRange(MapToolbarButton.GetMapToolbarButtons(this.MainMapStateId, false, MapToolbarButtonType.Geolocation));
            ...
            t.Add(MapToolbarCategory.Tools, ShowWindowToolbarButton.GetShowWindowToolbarButton(this.PreviewMapWindow, ShowWindowToolbarButtonType.PreviewWindow));

            t.Add(MapToolbarCategory.Tools, ShowWindowToolbarButton.GetShowWindowToolbarButton(this.DataWindow, ShowWindowToolbarButtonType.DataWindow));

            //t.Add(MapToolbarCategory.Tools, ShowWindowToolbarButton.GetShowWindowToolbarButton(this.DynamicObjectViewWindow, ShowWindowToolbarButtonType.DynamicObjectView));

            t.Add(MapToolbarCategory.Tools, ShowWindowToolbarButton.GetShowWindowToolbarButton(this.ScaleBandWindow, ShowWindowToolbarButtonType.ScaleBandsConfiguration));

            t.Add(MapToolbarCategory.Tools, ShowWindowToolbarButton.GetShowWindowToolbarButton(this.UserMapsWindow, ShowWindowToolbarButtonType.MapStorage));
            t.Add(MapToolbarCategory.Tools, new ShowWindowToolbarButton() { Window = this.WMCActionWindow, ToolTip = GetLocalResourceObject("WMC.ToolTip").ToString(), IconClassName = "wc_map_tb_wmc mwnt-wmc-action-button", MapToolbarCategoryId = MapToolbarCategory.Tools });
            ...
            t.Add(MapToolbarCategory.Tools, new ToolbarMapScaleControl { MapStateId = this.MainMapStateId });
            t.Add(MapToolbarCategory.Tools, new LanguageSelector());
            t.Add(MapToolbarCategory.Tools, new ShowWindowToolbarButton() { Window = this.AboutWindow, ToolTip = GetLocalResourceObject("About.ToolTip").ToString(), IconClassName = "wc_map_tb_abo mwnt-about-window-button", MapToolbarCategoryId = MapToolbarCategory.Tools });

            t.AddRange(MapToolbarCategory.Tools, MapToolbarButton.GetMapToolbarButtons(this.MainMapStateId, true, MapToolbarButtonType.DirectLink));
            ...
            //Authentication
            t.Add(new AuthorizationControl()/*new MembershipControl()*/);
            ...
            //Hide Seatch and Quality Monitor Tabs
            t.HideRibbonCategory(MapToolbarCategory.Search);
            t.HideRibbonCategory(QualityMonitorButton.CategoryId);
