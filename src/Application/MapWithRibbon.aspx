<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MapWithRibbon.aspx.cs" Inherits="Application.MapWithRibbon" GoogleMapsApi="true" VirtualEarthApi="true" Theme="Default" %>
...
<body>
    ...
    <ext:Viewport runat="server">
        ...
        <Items>
            <ext:Panel ID="MapContainer" SkinID="MapWithRibbonMapContainer" runat="server">
                <TopToolbar>
