...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:fn="http://www.w3.org/2004/10/xpath-functions" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" xmlns:ows="http://www.opengis.net/ows" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:fes="http://www.opengis.net/fes/2.0" xmlns:dct="http://purl.org/dc/terms/" xmlns:wfs="http://www.opengis.net/wfs">
  ...
  <xsl:template match="*[local-name()='Capabilities']">
    <html>
      <head>
        <title>
    ...
    ul li, ul li span {margin-top:0px; margin bottom:0px; line-height:150%;}
      ...
      -->
			...
			<xsl:variable name="cswCapsTranslation" select="document($translationPath)/lang"/>
      ...
      <body>
        ...
        <table id="main_table">
          ...
          <tr align="left">
            <th>
              <xsl:value-of select="$cswCapsTranslation/ServiceInformation"/><br/>
            </th>
            <th></th>
          </tr>
          <tr align="left">
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/ServiceType"/>:</span>
            </td>
            <td>
          ...
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/ServiceVersion"/>:  </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr align="left">
            <th>
              <xsl:value-of select="$cswCapsTranslation/ServiceProvider"/> <br/>
            </th>
            <th></th>
            <td/>
          </tr>
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/ProviderName"/>:  </span>
            </td>
              ...
              <span class="columnStyle">
                <xsl:choose>
                  <xsl:when test="$providerName = ''">
                    <xsl:value-of select="$cswCapsTranslation/NoAvailableData"/>
                  </xsl:when>
                  <xsl:otherwise>
          ...
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/ProvidersSite"/>:  </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr align="left">
            <th>
              <xsl:value-of select="$cswCapsTranslation/ContactInformation"/>: <br/>
            </th>
            <th></th>
            <td/>
          </tr>
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/IndividualName"/>: </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Phone"/>: </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Address"/>: </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr>
            <td>
              <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/EmailContact"/>: </span>
            </td>
            <td>
              <span class="columnStyle">
          ...
          <tr align="left">
            <th>
              <xsl:value-of select="$cswCapsTranslation/MetadataSection"/><br/>
            </th>
            <th></th>
          </tr>
          <br/>
          ...
          <xsl:for-each select=".//*[local-name()='Operation']">
            <tr>
              <td>
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Name"/>: </span>
              </td>
              <td>
                <span class="columnStyle">
            ...
            <tr>
              <td valign="top">
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Link"/>: </span>
              </td>
              <td>
                <span class="columnStyle">
                  HTTP Get:
            ...
            <xsl:for-each select=".//*[local-name()='Parameter']">
              <xsl:if test="./@name='AcceptVersions'">
                <tr>
                  <td valign="top">
                    <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/AcceptedVersion"/>: </span>
                  </td>
                  <td>
                    <span class="columnStyle">
                      <xsl:choose>
              ...
              <xsl:if test="./@name='AcceptFormats'">
                <tr>
                  <td valign="top">
                    <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/AcceptedFormat"/>: </span>
                  </td>
                  <td>
                    <span class="columnStyle">
                      <xsl:choose>
              ...
              <xsl:if test="./@name='outputFormat'">
                <tr>
                  <td valign="top">
                    <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/OutputFormat"/>: </span>
                  </td>
                  <td>
                    <span class="columnStyle">
                      <xsl:choose>
          ...
          <xsl:for-each select=".//*[local-name()='Parameter']">
            <xsl:if test="./@name='srsName'">
              <tr>
                <td valign="top">
                  <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/CoordinateSystem"/>: </span>
                </td>
                <td>
                  <span class="columnStyle">
                    <xsl:choose>
          ...
          <xsl:for-each select=".//*[local-name()='FeatureTypeList']">
            <tr align="left">
              <th>
                <xsl:value-of select="$cswCapsTranslation/FeatureTypeList"/><br/>
              </th>
              <th></th>
              <td/>
            </tr>
            <tr>
              <td valign="top">
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Operation"/>: </span>
              </td>
              <td>
                <span class="columnStyle">
            ...
            <xsl:for-each select=".//*[local-name()='FeatureType']">
              ...
              <tr>
                <td>
                  <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Title"/>: </span>
                </td>
                <td>
                  <span class="columnStyle">
                    <xsl:value-of select=".//*[local-name()='Title']"/>
              ...
              <tr>
                <td>
                  <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/DefaultSrs"/>: </span>
                </td>
                <td>
                  <xsl:choose>
              ...
              <tr>
                <xsl:choose>
                  <xsl:when test=".//*[local-name()='OtherSRS']">
                    <td valign="top">
                      <span class="spanBold">
                        <xsl:value-of select="$cswCapsTranslation/OtherSrs"/>:
                      </span>
                    </td>
                    <td>
                      <xsl:choose>
                  ...
                  <xsl:when test=".//*[local-name()='OtherCRS']">
                    <td valign="top">
                      <span class="spanBold">
                        <xsl:value-of select="$cswCapsTranslation/OtherCrs"/>:
                      </span>
                    </td>
                    <td>
                      <xsl:choose>
              ...
              <xsl:for-each select=".//*[local-name()='WGS84BoundingBox']">
                <tr>
                  <td valign="top">
                    <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/Wgs84Bbox"/>: </span>
                  </td>
                  <td>
                    <span class="columnStyle">
                      <xsl:value-of select="$cswCapsTranslation/LowerCorner"/>: 
                      <xsl:value-of select=".//*[local-name()='LowerCorner']"/>
                      <br/>
                      <xsl:value-of select="$cswCapsTranslation/UpperCorner"/>: 
          ...
          <xsl:for-each select=".//*[local-name()='Filter_Capabilities']">
            <tr align="left">
              <th>
                <xsl:value-of select="$cswCapsTranslation/FilterCapabilities"/><br/>
              </th>
              <th></th>
              <td/>
            </tr>
            <tr>
              <td valign="top">
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/GeometryOperands"/>: </span>
              </td>
              <td>
                <ul>
            ...
            <tr>
              <td valign="top">
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/SpatialOperators"/>: </span>
              </td>
              <td>
                <ul>
            ...
            <tr>
              <td valign="top">
                <span class="spanBold"><xsl:value-of select="$cswCapsTranslation/ComparisonOperators"/>: </span>
              </td>
              <td>
                <ul>
