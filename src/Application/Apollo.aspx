<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Apollo.aspx.cs" Inherits="Application.Apollo"
    GoogleMapsApi="true" VirtualEarthApi="true" Theme="Default" %>

<%@ Register assembly="ExtJS35" namespace="ExtJS.Controls" tagprefix="cc1" %>
            ...
            <ext:Panel ID="Panel1" runat="server" Region="Center">
                ...
                --%>               <LayoutConfig Type="Border" />
                                <Items>
                                    ...
                                    <ext:Panel Region="South" ID="TabPabelSearchResult" Height="250" Split="true">
                                    <LayoutConfig Type="Fit" />
                                        <Items>
