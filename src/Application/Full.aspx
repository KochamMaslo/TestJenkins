<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Full.aspx.cs" Inherits="Application.Full" GoogleMapsApi="true" VirtualEarthApi="true" Theme="Default" %>
    ...
    <ext:ViewPort runat="server">
        ...
        <Items>
            <ext:Panel ID="Banner" runat="server" Region="North" SkinID="Banner">
                <Content>
                    <h1><asp:Localize runat="server" meta:resourcekey="Title" /></h1>
                                            ...
                                            <ext:Panel runat="server" meta:resourcekey="MapContent" ID="MapContentCont" Cls="mwnt-sidebar-mapcontent-panel">
                                                ...
                                                <Items>
                                                    <ext:TabPanel ID="MapContent" runat="server">
                                                        <Items> 
                                                            <wc_core:MapLegendControl runat="server" Id="MapContentLayers" MapStateId="map" Mode="Layers" meta:resourcekey="Layers" cls="mwnt-sidebar-layers-panel" />
                                                            <wc_core:MapLegendControl runat="server" id="MapContentServices" MapStateId="map" Mode="Services" meta:resourcekey="DataSources" />
                                                            <wc_core:MapLegendControl runat="server" id="MapContentCategorized" MapStateId="map" Mode="Categorized" meta:resourcekey="Categories" />
                                                        </Items>
                                                    </ext:TabPanel>
                                                </Items>
                                            </ext:Panel>
...
--%>        </Items>
    ...
    <wc_core:DataWindow ID="DataWindow" runat="server" PageSize="20" ClipboardPageSize="10" meta:resourcekey="DataWindow" ConstrainHeader="true" MapStateId="map" Cls="mwnt-data-window"/>
