...
{
    public partial class Mobile : MapPageBase, IConfigurableForm
    {
        ...
        IEnumerable<ClientTool> IConfigurableForm.ClientTools
        {
            get
            {
                ...
                yield return new ClientTool("fit_all", GetLocalResourceObject("ZoomOut").ToString());
                yield return new ClientTool("where_am_i", GetLocalResourceObject("GoToMyLocation").ToString());
