...
{
    public partial class GeomediaWebMapPublisherApplicationPro : MapPageBase, IConfigurableForm
    {
        ...
        private void SetUpMapToolbar()
        {
            ...
            t.Add(ShowWindowToolbarButton.GetShowWindowToolbarButton(this.SimpleQueryWindow, ShowWindowToolbarButtonType.QueryWindow));
